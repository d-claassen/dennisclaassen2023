...
if ( ! function_exists( 'dc23_setup' ) ) :
	...
	function dc23_setup(): void {
		register_block_type( 'dc23/github-tree', [ 'render_callback' => \DC23\Blocks\GitHubTree\Tree::render( ... ) ] );
		register_block_type( 'dc23/github-breadcrumbs', [ 'render_callback' => \DC23\Blocks\GitHubBreadcrumbs\Breadcrumbs::render( ... ) ] );
